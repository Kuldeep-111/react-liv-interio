...
const AddBlog = () => {
  ...
  const fields = [
    { label: 'Title', name: 'heading', placeholder: 'Enter Title', col: 'md:col-span-6 lg:col-span-4' },
    ...
    { label: 'Mobile Image', name: 'mb_image', col: 'md:col-span-6 lg:col-span-4', type: 'image' },
    ...
    { label: 'Meta Title', name: 'meta_title', placeholder: 'Enter Meta Title', col: 'md:col-span-6 lg:col-span-4' },
    { label: 'Meta Keyword', name: 'meta_keywords', placeholder: 'Enter Meta Keyword', col: 'md:col-span-6 lg:col-span-4' },
    { label: 'Meta Description', name: 'meta_description', placeholder: 'Enter Meta Description', col: 'md:col-span-6 lg:col-span-4' },
  ];
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      await axiosAdmin.post(`${ADMIN_URL}blog`, formData);

      toast.success('Blog added successfully!');
      navigate('/admin'); // Replaces router.push
      reset();
      setEditorValue('');
      setImages({});
      setPreview({});
  ...
  if (resData?.messages && typeof resData.messages === "object") {
    Object.entries(resData.messages).forEach(([field, message]) => {
      toast.error(message); // Show just the message, or `${field}: ${message}` if you want field context
    });
